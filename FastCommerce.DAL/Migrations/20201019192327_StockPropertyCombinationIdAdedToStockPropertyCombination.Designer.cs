...
namespace FastCommerce.DAL.Migrations
{
    ...
    [Migration("20201019192327_StockPropertyCombinationIdAdedToStockPropertyCombination")]
    partial class StockPropertyCombinationIdAdedToStockPropertyCombination
    {
            ...
            modelBuilder.Entity("FastCommerce.Entities.Entities.PropertyDetail", b =>
                {
                    ...
                    b.HasIndex("StockPropertyCombinationId");
            ...
            modelBuilder.Entity("FastCommerce.Entities.Entities.PropertyDetail", b =>
                {
                    ...
                    b.HasOne("FastCommerce.Entities.Entities.StockPropertyCombination", "StockPropertyCombination")
                        .WithMany("PropertyDetails")
                        .HasForeignKey("StockPropertyCombinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
